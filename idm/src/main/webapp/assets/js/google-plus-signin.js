      ...
      return {
          ...
          link: function (scope, element, attrs, ctrl, linker) {
              ...
              if (!isAutoRendering && defaults.customtargetid === "googlebutton") {
                  ...
                  element[0].innerHTML =
                  '<div id="googlebutton" class="col-sm-2" style="text-align:center">' +
                  '<div>' +
                  '<button type="button" class="btn btn-primary btn-radius">' +
				  '<i class="ion-social-googleplus" style="color:#fff;font-size:18pt;width:40px"></i>'+
				  '</button>'+
                  ...
                  po.onload = function () {
                      ...
                      gapi.load('auth2', function () {
                          ...
                          if (isAutoRendering) {
                        	  ...
                        	  $rootScope.gapiAuth.attachClickHandler(defaults.customtargetid, {}, defaults.onsuccess, defaults.onfailure);
